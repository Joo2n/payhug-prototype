...
| 무엇 | 경로 |
|---|---|
| **최종본 묶음** | 사용자가 폴더를 `~/Downloads/투자자 어드민 UI/PAYHUG_용어정의서/` 로 옮김(2026-09-10). `최종/`(V1.3 · 입금부족액 반영판) · `최종_V1.3.1_20260909_입금부족액0/`(현행). 공유용 시연본 HTML 단독 묶음(GitHub 해제 대비, file:// 로 열림 · 폰트만 인터넷) `~/Downloads/투자자 어드민 UI/PAYHUG_시연본_투자자어드민_V1.3.1_20260909_1af503f/`(index.html · assets · README, 시연본 1af503f 와 md5 동일). 옛 경로 `~/Downloads/payhug_용어정의서/최종/` — `목록_V1.3_20260909.md` · `01_기호정리표` · `02_시연본_V1.3_20260909_7ba7f26` · `03_통합본_V1.3_20260909_d9af5a7` · `04_엑셀_V1.3_20260909` · `05_증명서_V1.3_20260909` · `06_Figma_V1.3_20260909` · `07_검증보고_20260909`. 다음 판은 새 폴더(`최종_V1.4_…`) |
