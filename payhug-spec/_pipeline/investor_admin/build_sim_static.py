...
def result_block(R):
    ...
    h += (('        <div class="stat">\n          <div class="summary-label">연환산 수익률</div>\n'
           ...
           '<span class="tip-panel">PY<sub>a</sub> = PMR × 365 ÷ PD'
           '<span class="tip-row"><span>PMR</span><span class="tip-green">%s%%</span></span>'
           '<span class="tip-row"><span>PM</span><span class="tip-green">%s원</span></span>'
           '<span class="tip-row"><span>PA</span><span class="tip-green">%s원</span></span>'
           '<span class="tip-row"><span>PD</span><span class="tip-green">%s일</span></span>'
           ...
           '<span class="tip-row"><span>PY<sub>a</sub></span><span class="tip-green">%s%%</span></span>'
           '<span class="tip-row"><span>Σ( A<sub>i</sub> × D<sub>i</sub> )</span><span class="tip-green">%s원</span></span>'
           '<span class="tip-row"><span>PEC</span><span class="tip-green">%s원</span></span>'
           '<span class="tip-row sum"><span>EC</span><span>%s원 × %d일</span></span>'
           '<span class="tip-row"><span>연환산</span><span class="tip-green">일부 기간의 수익률이 1년간 계속된다는 가정하에 예상되는 연간 수익률</span></span>'
           '</span></span></div>\n'
           '              <div class="summary-value">%s<span class="unit">%%</span></div>\n            </div>\n'
           '          </div>\n        </div>\n      </div>\n    </div>\n\n')
