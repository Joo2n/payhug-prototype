...
DESC = {
 ...
 "invest-profit--weekly.html":"투자 수익 · 주별 — 집계 단위 주별 · 프리셋 4주(2026-08-03~08-30) · 4행",
 "invest-profit--monthly.html":"투자 수익 · 월별 — 집계 단위 월별 · 프리셋 6개월(2026-03-01~08-31) · 6행",
 ...
 "rate_apply_result.md":"요율 정정 적용·로스터 16건 통일 결과 — 검산·재검증 전문",
 "roster16_model.py":"로스터 16건 모델 — 요율·가중평균·비중 잔차 산출",
 "roster16_apply.py":"정적 HTML·xlsx 적용기","roster16_apply.log":"적용 로그",
 ...
 "app_spec.json":"통합본 제작 사양","app_build_notes.md":"통합본 조립 지침","app_build_result.md":"통합본 제작 결과·검증",
 ...
 "components.html":"컴포넌트 갤러리 — 버튼·배지·표·토스트 견본",
