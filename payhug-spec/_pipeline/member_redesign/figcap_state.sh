...
# 사용: figcap_state.sh <state_id> <captureId> [viewportHeight(기본 1600)]   (서버: http.server 8902 --directory proto_fig)
...
rm -rf "$PROF" 2>/dev/null
echo "captured state=${ST} (cid ${CID}, vh ${VH})"
